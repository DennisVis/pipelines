...
def launch_template(project_id, container_spec_gcs_path, launch_parameters, 
    ...
    Args:
        ...
        container_spec_gcs_path (str): Required. Gcs path to a file with json serialized ContainerSpec as content.
    ...
    with KfpExecutionContext(on_cancel=cancel) as ctx:
        ...
        response = df_client.launch_flex_template(project_id, container_spec_gcs_path, 
