...
class LaunchFlexTemplateTest(unittest.TestCase):
    ...
    def test_launch_flex_template_succeed(self, mock_client, mock_context, mock_display,
        mock_storage):
        ...
        result = launch_flex_template('project-1', 'gs://foo/bar', {
            "parameters": {
                "foo": "bar"
            },
            "environment": {
    ...
    def test_launch_flex_template_retry_succeed(self,
    ...
    def test_launch_flex_template_fail(self, mock_client, mock_context, mock_display,
        mock_storage):
        mock_context().__enter__().context_id.return_value = 'context-1'
        mock_storage.Client().bucket().blob().exists.return_value = False
        mock_client().launch_flex_template.return_value = {
        ...
        self.assertRaises(RuntimeError,
            lambda: launch_flex_template('project-1', 'gs://foo/bar', {
                "parameters": {
                    "foo": "bar"
                },
                "environment": {
